...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case EnsureMoneyModelEntity:
			return ensureMoenyModelEntityFromJson(data as EnsureMoneyModelEntity, json) as T;    }
    return data as T;
  }

  static _getToJson<T>(Type type, data) {
		switch (type) {			case EnsureMoneyModelEntity:
			return ensureMoenyModelEntityToJson(data as EnsureMoneyModelEntity);    }
    return data as T;
  }
  //Go back to a single instance by type
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'EnsureMoenyModelEntity':
