...
ensureMoenyModelEntityFromJson(EnsureMoneyModelEntity data, Map<String, dynamic> json) {
...
Map<String, dynamic> ensureMoenyModelEntityToJson(EnsureMoneyModelEntity entity) {
